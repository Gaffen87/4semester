...
#### important files
![[Pasted image 20240910104359.png]]
...
![[Pasted image 20240918091915.png]]
Using directory traversal:  
![[Pasted image 20240918092120.png]]
Using `&x=` to stop remaining path from being appended by server  
![[Pasted image 20240918092245.png]]

### Spotting SSRF vulnerabilities:
- When a full URL is used in a parameterin the address bar![[Pasted image 20240918092901.png]]
- A hidden field in a form![[Pasted image 20240918092934.png]]
- A partial URL such as just the hostname![[Pasted image 20240918092959.png]]
- or only the path of the url![[Pasted image 20240918093024.png]]
...
- Proof of concept
	- fx making an alert pop-up  
		![[Pasted image 20240918103554.png]]
- Session stealing
	- Stealing the targets session cookies, such as login tokens![[Pasted image 20240918103626.png]]
- Key logger
	- Typing will be forwarded to attacker![[Pasted image 20240918103650.png]]
- Business logic
	- Calling a particular network resource or function![[Pasted image 20240918103752.png]]

### Reflected XXS
Happens when user-supplied data in an HTTP request is included in the webpage source without any validation
![[Pasted image 20240918104014.png]]
...
![[Pasted image 20240918105755.png]]
...
![[Pasted image 20240918110302.png]]
...
![[Pasted image 20240918110816.png]]
...
- `curl` command is a great way to test for command injection, cause u can use `curl` to deliver data to and from an app. ![[Pasted image 20240924103450.png]]
...
![[Pasted image 20240924121833.png]]

Bypassing filters:
Example: An app may filter quotation marks, but we can instead use the haxadecimal value to achieve same result
![[Pasted image 20240924122138.png]]
